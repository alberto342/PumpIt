...
//            "Sep", "Oct", "Nov", "Dec"};
    ...
    private static final int DEFAULT_SELECTOR_COLOR = Color.parseColor("#686DE0");
    ...
    private void gotoNextMonth() {
        ...
        if (month < 11) {
            ...
            dispatchOnMonthChanged(month + 1, MONTH_NAMES[month+1], year);
        } else {
            mCalendar.set(year + 1, 0, 1);
            dispatchOnMonthChanged(0, MONTH_NAMES[0], year+1);
        }
    ...
    private void gotoPreviousMonth() {
        ...
        if (month > 0) {
            ...
            dispatchOnMonthChanged(11, MONTH_NAMES[11], year-1);
        }
        initCalender(mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH));
    }
    ...
    protected void dispatchOnMonthChanged(final int numMonth, final String month, final int year) {
        if (monthListener != null) {
            monthListener.onMonthChanged(CalenderEvent.this, numMonth,month, year);
        }
    }
